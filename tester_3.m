...
x_cap4_samples = x_cap_all_4(:,1:5:length(x_cap_all_4));
x_cap3_samples = x_cap_all_3(:,1:5:length(x_cap_all_4));
x_vals = 1:5:length(x_cap_all_4(:,1:1:length(x_cap_all_4)));
x_l_vals = 0:(length(x_l_all_sample(1,:))-1);

%%
subplot(2,2,1);
hold on;
h1 = plot(0:T, (x_all_v3_1(:,1)));
h1 = plot(0:T, (x_all_v3_2(:,1)));
% h1 = plot(0:T, (x_all_v3_3(:,1)));
% h12 = plot(x_vals, x_cap4_samples(1,:), 'o');
% h16 = plot(x_vals, x_cap3_samples(1,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
xlim([0 500]);
title('with and without noise');
box on;

subplot(2,2,2);
hold on;
h1 = plot(0:T, (x_all_v3_1(:,2)));
h1 = plot(0:T, (x_all_v3_2(:,2)));
% h1 = plot(0:T, (x_all_v3_3(:,1)));
% h12 = plot(x_vals, x_cap4_samples(1,:), 'o');
% h16 = plot(x_vals, x_cap3_samples(1,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
...
subplot(2,2,3);
hold on;
h1 = plot(0:T, (x_all_v3_1(:,3)));
h1 = plot(0:T, (x_all_v3_2(:,3)));
% h1 = plot(0:T, (x_all_v3_3(:,1)));
% h12 = plot(x_vals, x_cap4_samples(1,:), 'o');
% h16 = plot(x_vals, x_cap3_samples(1,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
...
subplot(2,2,4);
hold on;
h1 = plot(0:T, (x_all_v3_1(:,4)));
h1 = plot(0:T, (x_all_v3_2(:,4)));
% h1 = plot(0:T, (x_all_v3_3(:,1)));
% h12 = plot(x_vals, x_cap4_samples(1,:), 'o');
% h16 = plot(x_vals, x_cap3_samples(1,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
...
% h1 = plot(0:T, (x_all_v3_2(:,2)));
h1 = plot(0:T, (x_all_v3_3(:,1)));
% h12 = plot(x_vals, x_cap4_samples(2,:), 'o');
% h16 = plot(x_vals, x_cap3_samples(2,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
xlim([0 500]);
title('without noise and quantisation');
box on;
...
% h2 = plot(0:T, x_l_all_1', Color="g");
xlim([0 500]);
title('without noise and sequence');
box on;
...
% h1 = plot(0:T, (x_all_v3_2(:,3)));
% h1 = plot(0:T, (x_all_v3_3(:,3)));
h12 = plot(x_vals, x_cap4_samples(3,:), 'o');
h16 = plot(x_vals, x_cap3_samples(3,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
xlim([0 500]);
title('user 3');
box on;
...
% h1 = plot(0:T, (x_all_v3_2(:,3)));
% h1 = plot(0:T, (x_all_v3_3(:,3)));
h12 = plot(x_vals, x_cap4_samples(4,:), 'o');
h16 = plot(x_vals, x_cap3_samples(4,:), 'x');
% h2 = plot(0:T, x_l_all_1', Color="g");
xlim([0 500]);
title('user 4');
box on;
